...
public class SecretUtil {
     ...
     * @throws Exception
     */
    public static String AESEncrypt(String data, String key, String algorithmParameter) throws Exception {
     ...
     * @throws Exception
     */
    public static String AESDecrypt(String data, String key, String algorithmParameter) throws Exception {
     ...
     * @throws Exception
     */
    private static String AESCipher(String data, String key, String algorithmParameter, int mode) throws Exception {
     ...
     * @return
     */
    public static String jiami(String secretKey, String mingwen) {
        String key = TranscodeUtil.strToBase64Str(secretKey);
        String miwen = "";
        try {
            miwen = SecretUtil.AESEncrypt(mingwen, key, secretKey);
        } catch (Exception e) {
            return "";
        }
        return miwen;
     ...
     * @return
     */
    public static String jiemi(String secretKey, String miwen) {
        String mingwen = "";
        try {
            String key = TranscodeUtil.strToBase64Str(secretKey);
            mingwen = SecretUtil.AESDecrypt(miwen, key, secretKey);
        } catch (Exception e) {
            return "";
        }
        return mingwen;
