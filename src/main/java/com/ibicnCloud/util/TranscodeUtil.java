...
public class TranscodeUtil {
    ...
    private static byte[] decode(char[] data) {
        ...
        if (index != out.length)
            System.out.println("解析的密文不符合长度要求！");
        return out;
    }
	...
	/*public static void main(String[] args) {
		String mingwen = "张梅甫1";
		String miwen = TranscodeUtil.strToBase64Str("张梅甫1");
		System.out.println("明文：" + mingwen);
		System.out.println("密文：" + miwen);
		System.out.println("密文：" + TranscodeUtil.base64StrToStr(miwen));

		mingwen = "张梅甫2";
		miwen = TranscodeUtil.strToBinStr("张梅甫2");
		System.out.println("明文：" + mingwen);
		System.out.println("密文：" + miwen);
		System.out.println("密文：" + TranscodeUtil.binStrToStr(miwen));

		mingwen = "张梅甫3";
		miwen = TranscodeUtil.strToHexStr("张梅甫3");
		System.out.println("明文：" + mingwen);
		System.out.println("密文：" + miwen);
		System.out.println("密文：" + TranscodeUtil.hexStrToStr(miwen));

		mingwen = "张梅甫4";
		miwen = TranscodeUtil.strToUnicodeStr("张梅甫4");
		System.out.println("明文：" + mingwen);
		System.out.println("密文：" + miwen);
		System.out.println("密文：" + TranscodeUtil.unicodeStrToStr(miwen));
	}*/

    public static void main(String[] args) {
//		String key = TranscodeUtil.strToBase64Str("WELKSDJIR2234L33");
//		System.out.println(key);
//		String UUID = "ZMF0000";
//		System.out.println(UUID);
//		String miwen = SecretUtil.AESEncrypt(UUID, key, "WELKSDJIR2234L33");
